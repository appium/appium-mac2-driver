 ...
 */
commands.desktopSetValue = async function desktopSetValue (opts = {}) {
 ...
 */
commands.desktopClick = async function desktopClick (opts = {}) {
  const uuid = util.unwrapElement(opts.element);
 ...
 */
commands.desktopClickAndHold = async function desktopClickAndHold (opts = {}) {
  const uuid = util.unwrapElement(opts.element);
 ...
 */
commands.desktopScroll = async function desktopScroll (opts = {}) {
  const uuid = util.unwrapElement(opts.element);
  const {
    x, y,
    deltaX, deltaY,
 ...
 */
commands.desktopRightClick = async function desktopRightClick (opts = {}) {
  const uuid = util.unwrapElement(opts.element);
  const { x, y, keyModifierFlags } = opts;
 ...
 */
commands.desktopHover = async function desktopHover (opts = {}) {
  const uuid = util.unwrapElement(opts.element);
  const { x, y, keyModifierFlags } = opts;
 ...
 */
commands.desktopDoubleClick = async function desktopDoubleClick (opts = {}) {
  const uuid = util.unwrapElement(opts.element);
  const { x, y, keyModifierFlags } = opts;
 ...
 */
commands.desktopClickAndDrag = async function desktopClickAndDrag (opts = {}) {
 ...
 * @property {?number} endY ending Y coordinate
 * @property {!number} duration long click duration in float seconds
 * @property {?number} velocity the dragging velocity in pixels per second.
 ...
 */
commands.desktopClickDragAndHold = async function desktopClickDragAndHold (opts = {}) {
  const sourceUuid = util.unwrapElement(opts.sourceElement);
  const destUuid = util.unwrapElement(opts.destinationElement);
  const {
    startX, startY,
 ...
 */
commands.desktopKeys = async function desktopKeys (opts = {}) {
  const uuid = util.unwrapElement(opts.element);
  const { keys } = opts;
